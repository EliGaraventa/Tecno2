...
let tonosFondo = [0, 320, 280, 300, 340];
let indiceTonoFondo;
let tonoFondo;

let gestorAudio;
let AMP_MIN = 0.04;
let umbralCambioFrecuencia = 150;
let frecuenciaBase = 400;
...
function draw() {
  ...
  background(color(tonoFondo, 70, 50));
  ...
  if (mouseIsPressed || frecuencia > frecuenciaBase) {
  ...
  let ancho3 = map(frecuenciaNormalizada, 0, 1, 150, mascara3.width * 1);
  let alto3 = map(frecuenciaNormalizada, 0, 1, 150, mascara3.height * 1);
